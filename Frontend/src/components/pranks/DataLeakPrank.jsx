...
export default function LoginPage() {
  ...
  return (
    <div className="max-w-lg mx-auto my-8 p-6 bg-white rounded-xl shadow-md">
      <h2 className="text-xl font-bold mb-4 text-indigo-700">Login Form</h2>
      {showNote && (
        <div className="mb-4 bg-blue-50 border border-blue-200 rounded p-3 text-blue-800 text-center font-medium">
          This was just for educational purposes. You can continue giving the quiz without logging in.
        </div>
      )}
      <form onSubmit={handleSubmit} autoComplete="off">
        ...
        <button type="submit" className="w-full bg-indigo-600 text-white py-2 rounded hover:bg-indigo-700 cursor-pointer">Login</button>
      </form>
