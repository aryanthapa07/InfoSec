  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
      <div className="bg-white rounded-xl shadow-lg p-8 max-w-md w-full relative">
        {!revealed ? (
          <>
            <h2 className="text-xl font-bold mb-2 text-indigo-700">Security Alert: Unusual Login Attempt</h2>
            <p className="mb-4 text-gray-700">
              We detected a suspicious login attempt on your account. Please <span className="text-blue-600 underline cursor-pointer" onClick={handleClick}>verify your account</span> to secure it.
            </p>
          ...
          <>
            ...
            <p className="mb-4 text-gray-700">
              This was a fake phishing email. Never click suspicious links or provide credentials unless you are sure of the sender. <br />
